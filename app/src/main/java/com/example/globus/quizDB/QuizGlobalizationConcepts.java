...
public class QuizGlobalizationConcepts extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.example.globus/databases/";
    private static final String Database_name = "concepts.db";//NAME of database stored in Assets folder
    private static final String Table_name = "concepts";//name of table
    ...
    public QuizGlobalizationConcepts(Context context) {//constructor
