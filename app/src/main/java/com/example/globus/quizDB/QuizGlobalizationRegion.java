package com.example.globus.quizDB;
...
public class QuizGlobalizationRegion extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.globus/databases/";
    private static final String Database_name = "regionalism.db";//NAME of database stored in Assets folder
    private static final String Table_name = "regionalism";//name of table
    ...
    public QuizGlobalizationRegion(Context context) {//constructor
