...
public class QuizGlobalizationNation extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.globus/databases/";
    private static final String Database_name = "nation.db";//NAME of database stored in Assets folder
    private static final String Table_name = "nation";//name of table
    ...
    public QuizGlobalizationNation(Context context) {//constructor
