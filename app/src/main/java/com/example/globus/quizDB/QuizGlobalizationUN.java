...
public class QuizGlobalizationUN extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.globus/databases/";
    private static final String Database_name = "un.db";//NAME of database stored in Assets folder
    private static final String Table_name = "un";//name of table
    ...
    public QuizGlobalizationUN(Context context) {//constructor
