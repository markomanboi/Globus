...
public class QuizGlobalizationEconomy extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.globus/databases/";
    private static final String Database_name = "economy.db";//NAME of database stored in Assets folder
    private static final String Table_name = "economy";//name of table
    ...
    public QuizGlobalizationEconomy(Context context) {//constructor
