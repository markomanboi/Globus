...
public class QuizGlobalizationSociety extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.globus/databases/";
    private static final String Database_name = "society.db";//NAME of database stored in Assets folder
    private static final String Table_name = "society";//name of table
    ...
    public QuizGlobalizationSociety(Context context) {//constructor
