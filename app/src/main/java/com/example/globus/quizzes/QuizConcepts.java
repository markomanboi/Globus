...
public class QuizConcepts extends AppCompatActivity {
    ...
    Button play_button;
    String get;
    QuizGlobalizationConcepts quizGlobalizationConcepts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_concepts);
        ...
        quizGlobalizationConcepts = new QuizGlobalizationConcepts(this);
        quizGlobalizationConcepts.createDatabase();
        quizGlobalizationConcepts.openDatabase();
        quizGlobalizationConcepts.getWritableDatabase();
    ...
    public void onClick(View v) {//When this method is executed then there will be new question came and also same method for play button
        ...
        if (visibility == 0) {
            ...
            new CountDownTimer(120000, 1000) {//countdowntimer
                ...
                public void onFinish() {
                    ...
                    editor.putInt("Globalization Concepts", l * 10).apply();
                    donutProgress.setProgress(0);
                    if(variable==0) {
                        Intent intent = new Intent(QuizConcepts.this, QuizResults.class);
        ...
        if (get.equals("c1")) {
            ...
            if (j==15 || time==0) {
                ...
                Ques = quizGlobalizationConcepts.readQuestion(list.get(j));
                Opta = quizGlobalizationConcepts.readOptionA(list.get(j));
                Optb = quizGlobalizationConcepts.readOptionB(list.get(j));
                Optc = quizGlobalizationConcepts.readOptionC(list.get(j));
                Optd = quizGlobalizationConcepts.readOptionD(list.get(j));
                global = quizGlobalizationConcepts.readAnswer(list.get(j++));
            }
