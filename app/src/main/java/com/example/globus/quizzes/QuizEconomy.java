...
public class QuizEconomy extends AppCompatActivity {
    ...
    Button play_button;
    String get;
    QuizGlobalizationEconomy quizGlobalizationEconomy;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizGlobalizationEconomy = new QuizGlobalizationEconomy(this);
        quizGlobalizationEconomy.createDatabase();
        quizGlobalizationEconomy.openDatabase();
        quizGlobalizationEconomy.getWritableDatabase();
    ...
    public void onClick(View v) {//When this method is executed then there will be new question came and also same method for play button
        ...
        if (visibility == 0) {
            ...
            new CountDownTimer(120000, 1000) {//countdowntimer
                ...
                public void onFinish() {
                    ...
                    editor.putInt("Economy", l * 10).apply();
                    donutProgress.setProgress(0);
                    if(variable==0) {
                        Intent intent = new Intent(QuizEconomy.this, QuizResults.class);
        ...
        if (get.equals("c1")) {
            ...
            if (j==15 || time==0) {
                ...
                Ques = quizGlobalizationEconomy.readQuestion(list.get(j));
                Opta = quizGlobalizationEconomy.readOptionA(list.get(j));
                Optb = quizGlobalizationEconomy.readOptionB(list.get(j));
                Optc = quizGlobalizationEconomy.readOptionC(list.get(j));
                Optd = quizGlobalizationEconomy.readOptionD(list.get(j));
                global = quizGlobalizationEconomy.readAnswer(list.get(j++));
            }
