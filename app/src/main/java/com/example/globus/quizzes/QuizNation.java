...
import com.example.globus.quizDB.QuizGlobalizationNation;
...
public class QuizNation extends AppCompatActivity {
    ...
    Button play_button;
    String get;
    QuizGlobalizationNation quizGlobalizationNation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_nation);
        ...
        quizGlobalizationNation = new QuizGlobalizationNation(this);
        quizGlobalizationNation.createDatabase();
        quizGlobalizationNation.openDatabase();
        quizGlobalizationNation.getWritableDatabase();
    ...
    public void onClick(View v) {//When this method is executed then there will be new question came and also same method for play button
        ...
        if (visibility == 0) {
            ...
            new CountDownTimer(120000, 1000) {//countdowntimer
                ...
                public void onFinish() {
                    ...
                    editor.putInt("Nation", l * 10).apply();
                    donutProgress.setProgress(0);
                    if(variable==0) {
                        Intent intent = new Intent(QuizNation.this, QuizResults.class);
        ...
        if (get.equals("c1")) {
            ...
            if (j==10 || time==0) {
                ...
                Ques = quizGlobalizationNation.readQuestion(list.get(j));
                Opta = quizGlobalizationNation.readOptionA(list.get(j));
                Optb = quizGlobalizationNation.readOptionB(list.get(j));
                Optc = quizGlobalizationNation.readOptionC(list.get(j));
                Optd = quizGlobalizationNation.readOptionD(list.get(j));
                global = quizGlobalizationNation.readAnswer(list.get(j++));
            }
